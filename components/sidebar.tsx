...
export default function Sidebar() {
  ...
  return (
    <aside className="flex w-56 shrink-0 flex-col border-r border-[var(--border)]">
      ...
      <div className="shrink-0 border-t border-[var(--border)] p-4">
        <button
          ...
          className="nav-item-hover flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-sm font-medium text-[var(--text-sub)] disabled:cursor-not-allowed disabled:opacity-40"
        >
